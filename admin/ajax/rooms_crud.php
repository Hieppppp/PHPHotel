<?php
    ...
    if(isset($_POST['add_room'])){ // Corrected key name
        ...
        // Add ForeignKey Room-Facilities
    ...
    if(isset($_POST['get_room_images'])){
        ...
        while($row = mysqli_fetch_assoc($res)){
            ...
            echo<<<data
                <tr class='align-middle'>
                    <td><img src='$path$row[image]' class='img-fluid larger-image'></td>
                    <td>$thumb_btn</td>
                    <td>
    ...
    if(isset($_POST['remove_room'])){
        ...
        $res1 = select("SELECT * FROM `room_images` WHERE `sr_no`=?",[$frm_data['room_id']],'i');
